...
Report incidents to the repository owner through GitHub (a private maintainer
contact or a [security advisory](SECURITY.md) if the report must stay private).
